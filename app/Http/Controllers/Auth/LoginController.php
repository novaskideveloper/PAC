...
//dd($stringArrayF);
//
//dd($resultsusuarioid['0']);
        //$tarefas = DB::select('select * from Tarefa where IdTarefa = :id', ['id' => '1' ]);

//        $users = DB::table('tarefa')->where('idTarefa', $stringArrayF)->get();
...
//                return view('dashboard/dashboard')->withName($results1);
                ...
                return view('dashboard/dashboard', compact('resultsemail','tarefas'));
